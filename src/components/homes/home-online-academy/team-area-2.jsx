            ...
            <div className={`edu-team-area ${about_p ? 'team-area-5 section-gap-large' : 'team-area-2 edu-section-gap'}`} style={{
                ...
                <div className="container">
                    <div className="section-title section-center" data-sal-delay="150"
                        ...
                        <h2 className="title" style={{ color: '#072B60', fontWeight: '700', marginBottom: '10px' }}>Our team</h2>
                        <p style={{
                            color: '#1E1E1E',
                            textAlign: 'center',
                            fontSize: '18px',
                            ...
                            Together, we can make the world a better place for children in need. We are young, motivated, and ethical professionals with 78+ current volunteers.
                        </p>
                    ...
                    <div style={{ overflow: 'hidden', whiteSpace: 'nowrap', marginTop: '60px' }}>
                        <div style={{
                            ...
                            {Array(3).fill(null).map((_, index) => (
                                <span key={index} style={{ marginRight: '40px' }}>
                                    <img src="/assets/images/icons/SIM icons-14.png" alt="Icon" style={{ verticalAlign: 'middle', marginRight: '10px' }} />
                                    <span style={dreamTextStyle}>Dare to lead</span>
                                </span>
                            ))}
                        </div>
                    </div>
