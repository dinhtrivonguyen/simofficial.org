        ...
        <div className="hero-banner hero-style-2 bg-image">
            <div className="container">
                <div className="row row--45 align-items-center">
                    <div className="col-lg-6">
                        <div className="banner-content">
                            ...
                            <div className="banner-gallery mobile">
                                ...
                                >
                                    <img
                                        src="/assets/images/banner/Ellipse 616.png"
                                        alt="Girl Image"
                                    />
                                </div>
                                <div
                                ...
                                >
                                    <img
                                        src="/assets/images/banner/Ellipse 617.png"
                                        alt="Man Image"
                                    />
                                </div>
                                <ul className="shape-group">
                                    ...
                                    >
                                        <img
                                            src="/assets/images/faq/Vector.png"
                                            alt="Shape"
                                        />
                                    </motion.li>
                                    ...
                                    >
                                        <img
                                            src="/assets/images/faq/SIM icons-34.png"
                                            alt="Shape"
                                        />
                                    </motion.li>
                                    ...
                                    <motion.li
                                        className="shape-5 scene shape-light"
                                        data-sal-delay="1000"
                                        data-sal="fade"
                                        data-sal-duration="1000"
                                        animate={{
                                    ...
                                    >
                                        <img
                                            src="/assets/images/cta/SIM icons-34.png"
                                            alt="Shape"
                                        />
                                    </motion.li>
                                </ul>
                            ...
                            <p
                                ...
                                data-sal-duration="1000"
                            >
                                We help ethnic minority girls escape child
                                marriages, child labor, human trafficking, water
                                insecurity, school dropouts, and poverty.
                            </p>
                            <div
                    ...
                    <div className="col-lg-6">
                        <div className="banner-gallery desktop">
                            <div
                                className="thumbnail thumbnail-1"
                                data-sal-delay="500"
                                data-sal="slide-up"
