...
const MissionArea = ({ home_3 = false, home_8 = false }) => {
    return (
        <div className="edu-brand-area brand-area-2 bg-image--1 our-mission-section">
            <div
                className={`${
                    home_3
            ...
            >
                <div className="container">
                    <div className="row g-5 section-title section-center">
                        ...
                        <p>
                            We inspire and empower young females to building a
                            brighter future and restoring hope
                        </p>
