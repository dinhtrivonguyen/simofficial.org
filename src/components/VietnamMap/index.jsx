...
const provinces = [
    { name: 'Hà Giang', coordinates: [22.7662056, 104.9388853], iconUrl: '/assets/images/icons/Frame 1000009144.png' },
    { name: 'Cao Bằng', coordinates: [22.665679, 106.2522144], iconUrl: '/assets/images/icons/Frame 1000009144.png' },
    { name: 'Lạng Sơn', coordinates: [21.853639, 106.761304], iconUrl: '/assets/images/icons/Frame 1000009144.png' },
    { name: 'Sơn La', coordinates: [21.102228, 103.728917], iconUrl: '/assets/images/icons/Frame 1000009144.png' },
    { name: 'Lào Cai', coordinates: [22.485722, 103.97532], iconUrl: '/assets/images/icons/Frame 1000009144.png' },
    { name: 'Quảng Trị', coordinates: [16.794347, 107.072738], iconUrl: '/assets/images/icons/Frame 1000009144.png' },
    { name: 'Thừa Thiên Huế', coordinates: [16.467397, 107.590532], iconUrl: '/assets/images/icons/Frame 1000009144.png' },
    { name: 'Đà Nẵng', coordinates: [16.047079, 108.206230], iconUrl: '/assets/images/icons/Frame 1000009144.png' },
    { name: 'Hiệp Đức', coordinates: [15.903063, 108.132959], iconUrl: '/assets/images/icons/Frame 1000009144.png' },
...
const VietnamMap = () => {
    ...
    return (
        <>
            ...
            `}</style>
            <MapContainer center={[18.6765, 105.6868]} zoom={6.5} style={{ height: '800px', width: '100%' }}>
                <TileLayer
                                ...
                                <div>
                                    ...
                                    {provinceDetails[province.name] ? (
                                        <>
                                            ...
                                            <div>Location: {provinceDetails[province.name].location}</div>
