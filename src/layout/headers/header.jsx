                        ...
                        <div className="header-navbar">
                            <div className="header-brand">
                                <div className="logo">
                                    <Link href={'/'}>
                                        <a>
                                            <img className="logo-light" src='/assets/images/logo/SIM logo_second logo pink.png' alt="logo" />
                                            <img className="logo-dark" src='/assets/images/logo/SIM logo_second logo pink.png' alt="logo" />
                                        </a>
                                    </Link>
                                </div>
                            </div>
