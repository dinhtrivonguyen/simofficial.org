                        ...
                        <div className="header-navbar">
                            <div className="header-brand">
                                <div className="logo">
                                    <Link href="/">
                                        <a>
                                            <img className="logo-light" src={style_3 ? '/assets/images/logo/SIM logo_second logo pink.png' : "/assets/images/logo/logo-dark-2.png"} alt="Corporate Logo" />
                                            <img className="logo-dark" src={style_3 ? '/assets/images/logo/SIM logo_second logo pink.png' : "/assets/images/logo/logo-light-2.png"} alt="Corporate Logo" />
                                        </a>
                                    </Link>
                                </div>
                            </div>
