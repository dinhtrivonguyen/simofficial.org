                        ...
                        <div className="header-brand">
                            <div className="logo">
                                <Link href="/">
                                    ...
                                    <img className="logo-light" src="/assets/images/logo/SIM logo_second logo pink.png" alt="Corporate Logo" />
                                    <img className="logo-dark" src="/assets/images/logo/SIM logo_second logo pink.png" alt="Corporate Logo" />
                        ...
                        <div className="header-right">
                            <ul className="header-action">
                                ...
                                <li className="header-btn">
                                    <Link href="#" className="edu-btn btn-medium btn-curved">
                                        Donate now<i className="icon-4"></i>
                                    </Link>
                                </li>
